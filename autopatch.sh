...
utils_dir="$top_dir/vendor/surface-drivers"
...
if  [ "$1" == "4.19" ];then
	patch_dir="$utils_dir/ipts/patches/4.19"
elif [ "$1" == "5.7" ];then
	patch_dir="$utils_dir/ipts/patches/5.7"
else
	patch_dir="$utils_dir/ipts/patches/dummy"
